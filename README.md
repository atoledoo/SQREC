...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Em prol de fomentar a interação entre os trabalhadores e trazer maior engajamento para a fábrica, o time de Lean Manufacturing juntamente com a gerência da empresa, desenvolveu uma adaptação à antiga ferramenta utilizada, uma ferramenta cujo se trata do acrônimo de Segurança, Qualidade, Recursos, Engajamento e Checar (planilha de acompanhamento da produção), reconhecida pelo acrônimo SQREC.<br><br>
